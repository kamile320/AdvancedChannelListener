...
Everything works and creates automatically. All you need to do is load this module into a supported Discord bot that uses cogs - like [ServerBot](https://github.com/kamile320/ServerBot).  
...
| [Carl-bot](https://github.com/CarlGroth/Carl-Bot) | n/a | Modified | Used as a compatibility test-bench. After complete code reconstruction to modern libraries and adding modification above, the ACL module works perfectly. |
